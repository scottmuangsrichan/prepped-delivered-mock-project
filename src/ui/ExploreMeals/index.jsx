...
export default function ExploreMeals(){
    return (
      <div className='w-screen bg-menuBackground p-12'>
        <div className='bg-white flex m-auto flex-col border-2 border-solid p-10 sm:max-w-[50%] text-center'>
          <div>

          <h1 className='font-bold text-4xl pb-4'>On the Menu</h1>
          ...
          <div className='sm:grid grid-rows-2 grid-cols-3 place-content-center mx-auto gap-1 pb-8'>
            <MenuItemCard 
